...
In this case, both searches run on the same graph.
...
We implemented the undirectional stopping criterion.
However, often the search stops early because the queues are empty.
