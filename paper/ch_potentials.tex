...
We introduce a novel potential function which utilizes Contraction Hierarchies to efficiently calculate perfect potentials on road networks. % TODO not the function is novel
...
A*~\cite{hnr-afbhd-68} extends Dijkstra's algorithm by changing the order in which nodes are visited such that nodes in the direction of $t$ are visited earlier.
