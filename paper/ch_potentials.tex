...
% TODO contribution vs conference
...
However, the approach in~\cite{adgw-arrn-13} uses a simpler penalization schema.
We also implement this approach with CH-Potentials but with the penalization schema from Kobitzsch~\cite{kobitzsch2015alternative}.
