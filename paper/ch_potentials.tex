...
\section{Avoiding Potential Evaluations}
...
\subsection{Largest Biconnected Component}
...
\begin{itemize}
\item Avoid nothing running times, i.e., what is if $w_q = q_\ell$?
\item Multiply all weights by $\alpha$ for $\alpha$ in 1.1, 1.5, 2, 3
\item Avoid highway
\item Avoid tunnel
...
\item Running times if OSM degree 2 nodes are not extracted!
\end{itemize}
