...
CH is extended to support turn costs in~\cite{gv-errnt-11}, CCH in~\cite{bwzz-cchtc-20}.
Traffic predictions are combined with CH in~\cite{swz-sfert-20,bgsv-mtdtt-13}.
...
As we were able to keep all travel time functions out of the CH, we avoid a lot of algorithmic complications compared to~\cite{bgsv-mtdtt-13,bdpw-dtdrp-16,swz-sfert-20}, which create shortcuts of travel time functions to combine hierarchical speedup techniques with time-dependent routing.
