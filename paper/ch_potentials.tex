...
\pdfinfo{
/Title (A Fast and Preprocessing-Tight Heuristic for A* in Road Networks)
/Author (Foo Bar)
/Keywords (shortest path, road graphs, goal-directed search, contraction hierarchy, heuristic search)
}
\title{A Fast and Preprocessing-Tight Heuristic for A* in Road Networks}
\author{Foo Bar}
...
We say that this heuristic that is tight with respect to $w_\ell$ is \emph{preprocessing-tight}.
