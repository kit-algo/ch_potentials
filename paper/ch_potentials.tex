...
We perform experiments on several graphs with travel time weights which we modify in different ways.
...
One is an old instance of Germany from 2006 (4.7M nodes, 10.7M edges) and the other a newer instance of Europe (25.8M nodes, 55.5M edges).
