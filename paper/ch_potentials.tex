...
The A* search uses the tentative distance $\tau$ at a node $u$ when to evaluating the travel time of outgoing edges $u v$.
...
Only for small ball sizes it is marginally faster when computing distances for more then 4096 sources.
