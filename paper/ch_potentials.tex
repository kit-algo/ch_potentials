...
% --- ich habe turn costs weg gelassen, weil wir die nicht in den experimenten haben, ich will keiner Reviewer auf blöde Ideeen bringen
...
This includes turn restrictions, live traffic, user preferences, traffic predictions.%, temporary driving bans for certain types of vehicles.
